  ...
  return <>
    <main>
      <section className="hero" id="header">
        <header className="hero-header"><Image src="/logos/united-sales-logo.png" alt="Объединённый отдел продаж" width={1500} height={308} priority /></header>
